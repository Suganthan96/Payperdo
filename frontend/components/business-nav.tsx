...
export function BusinessNav() {
  ...
  const navItems = [
    ...
    { name: 'Create Task', path: '/business/Createtask', icon: '➕' },
    { name: 'Completed Tasks', path: '/business/Completedtask', icon: '✅' },
  ]
  ...
  return (
    <nav className="bg-gray-900 border-b border-gray-800 px-4 py-3">
      <div className="container mx-auto flex items-center justify-between">
        {/* Logo */}
        <Link href="/business/dashboard" className="text-xl font-bold text-yellow-500">
          Payperdo Business
        </Link>
